...
- `Object.get` of a `List<String>` `@ScriptProperty` (and any `call(...)` whose result is an Array,
  Dictionary or Packed*Array) returned null on iOS; desktop returned the container. The C call path
