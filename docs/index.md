...
| Web | Experimental (Kotlin/Wasm preview, 4.7 stable); 11 of the 12-demo corpus in Chrome/Firefox CI (tps-demo is a local gate) + a local Safari gate; source-checkout export, desktop browsers only (iOS hand-checked, ungated), not Supported |
