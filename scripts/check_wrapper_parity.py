...
The 28 hand-shaped wrapper classes exist twice — `src/jvmMain/.../api/<Class>.kt` and
...
# The 28 classes the generated tree (src/sharedApi) extends or calls that are NOT part of that
...
# StandardMaterial3D is hand/hand, 21 are hand on desktop + GENERATED on iOS, Image/PlaneMesh are
...
HAND_SHAPED = [
    ...
    "Node3D", "Button", "ArrayMesh", "EditorExportPlatform", "PackedScene", "Light3D",
