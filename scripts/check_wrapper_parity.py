...
The 27 hand-shaped wrapper classes exist twice — `src/jvmMain/.../api/<Class>.kt` and
...
# The 27 classes the generated tree (src/sharedApi) extends or calls that are NOT part of that
...
# StandardMaterial3D is hand/hand, 20 are hand on desktop + GENERATED on iOS, Image/PlaneMesh are
