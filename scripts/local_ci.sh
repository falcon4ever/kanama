...
# 24 = the example HelloScript's exported properties incl. metadata/tool-button
...
# plus MutableMap (smoke_mutable_map). Bump when the example gains/loses one.
if ! rg -q 'propertyCount = 24' "$hello_script_registrar"; then
