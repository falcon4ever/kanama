...
class NavigationLink2D(handle: GodotHandle) : Node2D(handle) {
    ...
    fun setStartPosition(position: Vector2) {
        ObjectCalls.ptrcallWithVector2Arg(setStartPositionBind, segment, position)
    }
    ...
    fun setEndPosition(position: Vector2) {
        ObjectCalls.ptrcallWithVector2Arg(setEndPositionBind, segment, position)
    }
    ...
    fun getEndPosition(): Vector2 {
        return ObjectCalls.ptrcallNoArgsRetVector2(getEndPositionBind, segment)
    }
    ...
    fun setGlobalStartPosition(position: Vector2) {
        ObjectCalls.ptrcallWithVector2Arg(setGlobalStartPositionBind, segment, position)
    }
    ...
    fun getGlobalStartPosition(): Vector2 {
        return ObjectCalls.ptrcallNoArgsRetVector2(getGlobalStartPositionBind, segment)
    }
    ...
    fun setGlobalEndPosition(position: Vector2) {
        ObjectCalls.ptrcallWithVector2Arg(setGlobalEndPositionBind, segment, position)
    }
    ...
    fun getGlobalEndPosition(): Vector2 {
        return ObjectCalls.ptrcallNoArgsRetVector2(getGlobalEndPositionBind, segment)
    }
