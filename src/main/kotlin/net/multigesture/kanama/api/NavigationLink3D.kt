...
class NavigationLink3D(handle: MemorySegment) : Node3D(handle) {
    ...
    /**
     * Whether this link is currently active. If `false`, `NavigationServer3D.map_get_path` will ignore
     * this link.
     *
     ...
     * be checked when requesting a path with `NavigationServer3D.map_get_path`.
     *
