 ...
 */
fun PhysicsDirectSpaceState3D.intersectPoint(parameters: PhysicsPointQueryParameters3D, maxResults: Int = 32): List<Map<String, Any?>> {
 ...
 */
fun PhysicsDirectSpaceState3D.intersectShape(parameters: PhysicsShapeQueryParameters3D, maxResults: Int = 32): List<Map<String, Any?>> {
 ...
 */
fun PhysicsDirectSpaceState3D.getRestInfo(parameters: PhysicsShapeQueryParameters3D): Map<String, Any?> {
