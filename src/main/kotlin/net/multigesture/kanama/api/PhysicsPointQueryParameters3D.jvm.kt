...
// GENERATED desktop/Android companion for PhysicsPointQueryParameters3D (scripts/generate_api_wrapper.py --write-tree).
// DO NOT EDIT BY HAND. These members are not in the shared wrapper tree: iOS has no audited
// ObjectCalls helper for their ptrcall shape yet (or does not host a wrapper type they use), so
// they compile for desktop/Android only. Re-run the generator when iOS gains the helper.
// KANAMA-IOS-GAP PhysicsPointQueryParameters3D waits on: ptrcallNoArgsRetRIDList,
 ...
 */
fun PhysicsPointQueryParameters3D.setExclude(exclude: List<RID>) {
    checkOpen()
 ...
 */
fun PhysicsPointQueryParameters3D.getExclude(): List<RID> {
    checkOpen()
    return ObjectCalls.ptrcallNoArgsRetRIDList(getExcludeBind, handle)
}

var PhysicsPointQueryParameters3D.exclude: List<RID>
