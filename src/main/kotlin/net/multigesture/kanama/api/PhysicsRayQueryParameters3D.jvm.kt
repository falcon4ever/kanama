...
// KANAMA-IOS-GAP PhysicsRayQueryParameters3D waits on: ptrcallNoArgsRetRIDList,
//   ptrcallWithRIDListArg, ptrcallWithTwoVector3UInt32RIDListArgsRetObject
 ...
 */
fun PhysicsRayQueryParameters3D.getExclude(): List<RID> {
    checkOpen()
    return ObjectCalls.ptrcallNoArgsRetRIDList(getExcludeBind, handle)
}

var PhysicsRayQueryParameters3D.exclude: List<RID>
