...
// GENERATED desktop/Android companion for PhysicsShapeQueryParameters2D (scripts/generate_api_wrapper.py --write-tree).
// DO NOT EDIT BY HAND. These members are not in the shared wrapper tree: iOS has no audited
// ObjectCalls helper for their ptrcall shape yet (or does not host a wrapper type they use), so
// they compile for desktop/Android only. Re-run the generator when iOS gains the helper.
// KANAMA-IOS-GAP PhysicsShapeQueryParameters2D waits on: ptrcallNoArgsRetRIDList,
 ...
 */
fun PhysicsShapeQueryParameters2D.setExclude(exclude: List<RID>) {
    checkOpen()
 ...
 */
fun PhysicsShapeQueryParameters2D.getExclude(): List<RID> {
    checkOpen()
    return ObjectCalls.ptrcallNoArgsRetRIDList(getExcludeBind, handle)
}

var PhysicsShapeQueryParameters2D.exclude: List<RID>
