...
//   ptrcallWithBoolArgRetString, ptrcallWithDictionaryAndBoolArgRetString,
...
fun Time.getDateTimeStringFromUnixTime(unixTime: Long, useSpace: Boolean = false): String {
    return ObjectCalls.ptrcallWithLongAndBoolArgRetString(getDateTimeStringFromUnixTimeBind, timeSingleton, unixTime, useSpace)
}
 ...
 */
fun Time.getDateStringFromUnixTime(unixTime: Long): String {
    return ObjectCalls.ptrcallWithLongArgRetString(getDateStringFromUnixTimeBind, timeSingleton, unixTime)
}
 ...
 */
fun Time.getTimeStringFromUnixTime(unixTime: Long): String {
    return ObjectCalls.ptrcallWithLongArgRetString(getTimeStringFromUnixTimeBind, timeSingleton, unixTime)
}
 ...
 */
fun Time.getOffsetStringFromOffsetMinutes(minutes: Long): String {
    return ObjectCalls.ptrcallWithLongArgRetString(getOffsetStringFromOffsetMinutesBind, timeSingleton, minutes)
}
...
fun Time.getDateTimeStringFromSystem(utc: Boolean = false, useSpace: Boolean = false): String {
    return ObjectCalls.ptrcallWithTwoBoolArgsRetString(getDateTimeStringFromSystemBind, timeSingleton, utc, useSpace)
}
 ...
 */
fun Time.getDateStringFromSystem(utc: Boolean = false): String {
    return ObjectCalls.ptrcallWithBoolArgRetString(getDateStringFromSystemBind, timeSingleton, utc)
}
 ...
 */
fun Time.getTimeStringFromSystem(utc: Boolean = false): String {
    return ObjectCalls.ptrcallWithBoolArgRetString(getTimeStringFromSystemBind, timeSingleton, utc)
}
