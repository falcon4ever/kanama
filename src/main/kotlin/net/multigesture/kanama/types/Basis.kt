...
data class Basis(
   ...
   */
  fun inverse(): Basis = callNoArgsRetBasis("inverse", INVERSE_HASH)
   ...
   */
  fun orthonormalized(): Basis = callNoArgsRetBasis("orthonormalized", ORTHONORMALIZED_HASH)
   ...
   */
  fun getScale(): Vector3 = callNoArgsRetVector3("get_scale", GET_SCALE_HASH)
